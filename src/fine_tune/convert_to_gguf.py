...
# -----------------------------
BASE_MODEL = (
    "mistralai/Mistral-7B-Instruct-v0.3"  # path or HF repo of base model
)
LORA_ADAPTER_PATH = "./lora-mistral-domain/lora_adapter"  # LoRA adapter output
MERGED_OUTPUT_DIR = "./mistral_7B_merged"  # merged HF model output
